...
class OrderPlacingViewModel (application: Application, private val repository: CartRepository) : BaseViewModel(application){
    ...
    fun addFavourite(){
        ...
        launch {
            repository.insertProduct(CartItem(0, Constant.PRODUCT_LIST[1]))
        }
    }
